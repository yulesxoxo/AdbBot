...
from adb_bot.cv.ocr import OEM, PSM, TesseractBackend, TesseractConfig
...
class TestTesseractBackendInfo(unittest.TestCase):
    ...
    @patch("adb_bot.cv.ocr.tesseract_backend._initialize_tesseract")
    ...
    @patch("adb_bot.cv.ocr.tesseract_backend._initialize_tesseract")
    @patch("adb_bot.cv.ocr.tesseract_backend.pytesseract.get_tesseract_version")
    ...
    @patch("adb_bot.cv.ocr.tesseract_lang.Lang.get_supported_languages")
